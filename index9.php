...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The timer indicates time left for others users to tweet your message. 
		<div style="font-size:26px;">Congrats, you have won a minority game. Your message will now be re-tweeted by the rest users<br></div>		
		</span></td></tr>
