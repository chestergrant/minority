...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The timer indicates time left to validate other users has tweeted the winning message.<br><br>
		Please note you will need to validate atleast (5) users that they have tweeted the winner's message else you will not be able to participate in the next 5 minority game.
		<div style="font-weight:bold;font-size:26px;color:black;"><br>Validate<span style="color:white;">(5/5)</span></div>
		Click on the link to the twitter account below. Click valid if the user has as a tweeted:"Nottingham is the number 1 school", invalid otherwise.
		<div style="background:rgba(255,255,255,0.5);color:black; width:500px">Twitter Account: <a href="http://www.twitter.com/xyzgra" target="_blank">@xyzgra</a></div>
		<form><table style="width:500px;"><tr><td><input type="submit" class="flatsubmit" style="width:170px !important;" value="Valid"></td><td><input type="submit" class="flatsubmit" style="width:170px !important;" value="Invalid"></td></tr></table></form>
		</span></td></tr>
