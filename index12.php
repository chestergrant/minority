...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The timer indicates time left for round to end.<br><br>
		 You are currently not participating in this round of minority game. Please wait while we gather the results for this round.
		</span></td></tr>
