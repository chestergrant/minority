...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The minority game has begun. The timer indicates time left for you to make a choice. 
		<div><br><br>Number of participants left: 3219</div>
		<div>Please select an item by clicking on an image below:<br></div>
		<div><table style="width:500px"><tr><td style="width:250px"><center><a href=""><img src="images/burger.jpg"></a></center></td><td><center><a href=""><img src="images/pizza.jpg"></a></center></td>
		</tr><tr><td><center>Item 1</center></td><td><center>Item 2</center></td></tr></table></div>
		</span></td></tr>
