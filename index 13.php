...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The timer indicates time left for the next round to begin.<br><br>
		The results for the last round of minority game:
