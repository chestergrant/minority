...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The timer indicates time left before the next minority game begins. 
		<div style="font-size:26px;">Sorry, You have not been approved to play the minority game. Feel free to enter next time.</div>
		<div>The reason:<br>Invalid Twitter Account<br>|Inappropriate message<br>|Not validating enough other users<br>|Not validating enough twitter messages</div>
		</span></td></tr>
