...
<tr><td style="height:100px;width:300px"><center>
 <div class="demo">            
            <input class="knob" id="counter" data-width="100" data-height="100" data-max="600" data-thickness="0.2" readonly data-displayInput=true value="0">
			 <script>
        function cd() {
            var $s = $("#counter");
                d = new Date();
		...
		<tr><td style="width:500px"><span style="color:white;margin-top:0px;margin-left:0px;">The timer indicates time left before the next minority game begins. Before the timer runs out you must accomplish the following:
		<ol><li><strike>Enter your tweet that you want tweeted to the world.</strike></li>
		...
		<div style="font-weight:bold;font-size:26px;color:black;">Step 3<span style="color:white;">(5/5)</span></div>
		Read the tweet below, and click whether it is an appropriate message to tweet. See rules about appropriateness(basically ask yourself if you would want to tweet this).
		<div style="background:rgba(255,255,255,0.5);color:black; width:500px">Tweet: Could you please stop quoting other people. Think for yourself.</div>
		<form><table style="width:500px;"><tr><td><input type="submit" class="flatsubmit" style="width:170px !important;" value="Appropriate"></td><td><input type="submit" class="flatsubmit" style="width:170px !important;" value="Not Appropriate"></td></tr></table></form>
